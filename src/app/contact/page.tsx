...
export default function HelpCenterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // 2. Send it to your Next.js API route
      ...
      <div className="bg-gray-50 py-16 sm:py-24 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
            Browse our help center, chat with us live, or send a message. We're here to ensure your experience is perfect.
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                {/* This triggers your messaging app */}
                <button 
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:support@justtattoos.com" className="mt-2 text-sm font-bold text-blue-600 hover:text-blue-800 block">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="/policies/refund-policy" className="mt-2 text-sm font-bold text-blue-600 hover:text-blue-800 block">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm py-3 px-4 bg-gray-50 border"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    required
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring-black sm:text-sm py-3 px-4 bg-gray-50 border resize-none"
                ...
                <button
                  ...
                  className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-colors disabled:opacity-70"
                >
                  {isSubmitting ? (
