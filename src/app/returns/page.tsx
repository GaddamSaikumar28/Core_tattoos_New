...
// =========================================================
// 1. UPDATED SEO METADATA GENERATOR
// =========================================================
...
async function ReturnsContent() {
  ...
  // =========================================================
  // 🚀 SEO: INJECT RETURNS & POLICY SCHEMAS
  // =========================================================
  ...
  const schemas: any[] = [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Returns", "item": `${siteUrl}/returns` }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      "@id": `${siteUrl}/returns#faq`,
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the refund and credit timeframe?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We are happy to assist with refunds or store credits within 14 days from the date your order is delivered. Requests made after 14 days may still qualify for store credit, but orders older than 90 days are not eligible."
          }
        },
        {
          "@type": "Question",
          "name": "Are final sale items eligible for a refund?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, final sale items are strictly not eligible for refunds or credits. This includes tattoo accessories, marker products, gift cards, sale items, and tattoo bundles."
          }
        },
        {
          "@type": "Question",
          "name": "What if my product is defective or damaged?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "If your order arrives damaged, defective, or you experience an application issue, please email support with your order number and clear photos. Eligible cases may qualify for a one-time replacement or store credit."
          }
        }
      ]
    },
