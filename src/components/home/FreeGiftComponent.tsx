...
//           <h2 className="text-3xl md:text-5xl text-[#fe8204]  font-bold text-white uppercase leading-tight">
//             Free gift with your order 
//           </h2>
//           <p className="text-base md:text-lg  font-medium text-gray-300 mt-4 md:mt-6 max-w-4xl leading-relaxed">
...
//           </p>
//           <p className="text-base md:text-lg  font-medium text-[var(--color-brand-orange,#FE8204)] mt-3">
...
//               </h3>
//               <p className="text-sm md:text-base  font-normal text-gray-800 mb-8 max-w-[320px] leading-relaxed">
    ...
    <section className="bg-white w-full overflow-hidden px-4 py-16 md:px-8 lg:px-16 md:py-24 relative">
      <div className="max-w-[1312px] mx-auto">
        ...
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base md:text-lg  font-medium text-gray-600 mt-4 md:mt-6 max-w-4xl leading-relaxed">
            Who doesn’t love a surprise? Spend $30 USD or more and we’ll toss in a mystery ink on us. Realistic tattoo look, water-resistant, and designed to last up to 10 days. At Just Tattoos, we make it easy to switch up your style, no commitment required.
          </p>
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          >
            ...
            <div className="mt-auto">
              ...
              <p className="text-sm md:text-base  font-medium text-gray-700 mb-8 max-w-[320px] leading-relaxed">
                High-quality ink, on the house. Reach $30 and we’ll drop a mystery design into your order. New style, zero cost.
              </p>
