...
// 🚀 TURBOPACK COMPLIANT BOUNDARY: Client context safely defers WebGL load 
    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-[#050505] relative overflow-hidden">
      ...
      <div className="relative w-20 h-20 mb-6 z-10">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg viewBox="0 0 40 40" className="w-10 h-10" fill="#FF7A00">
            <path d="M20 5 C20 5, 30 18, 30 24 C30 30, 25.5 35, 20 35 C14.5 35, 10 30, 10 24 C10 18, 20 5, 20 5 Z" />
          </svg>
        </div>
      </div>
      <p className="text-xs text-neutral-500 font-medium tracking-widest uppercase animate-pulse">
        Loading 3D Lookbook...
      </p>
    </div>
  );
...
export default function BookClientLoader({ products }: { products?: TattooProduct[] }) {
